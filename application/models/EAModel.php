<?php
class EAModel extends CI_Model{
    protected $pa_id;
    protected $pa_team;
    protected $pa_atleta;
	...
	public function save($data = null) {
        if ($data != null) {
            if ($this->db->insert('et_atletas', $data)) {
                return true;
            }
        }
    }
    ...
    public function update($data = null) {
        if ($data != null) {
            ...
            if ($this->db->update('et_atletas', $data)) {
                return true;
            }
        }
    }
    ...
    public function truncate() {
        if ($this->db->truncate("et_atletas")) {
            return true;
        }
    }
    ...
    public function listing() {
        ...
        return $this->db->get("et_atletas")->result();
    }
	
	public function search($pa_id) {
        $this->db->where("pa_id", $pa_id);
        return $this->db->get("et_atletas")->row_array();
    }
	...
	public function getsquadout($pa_team) {
        $this->db->where("pa_team", $pa_team);
        $this->db->join('eliminatorio', 'eliminatorio.et_id=pa_team', 'inner');
        $this->db->join('atletas', 'atletas.atletasid=pa_atleta', 'inner');
