...
class PRModel extends CI_Model{
	...
	public function save($data = null) {
        if ($data != null) {
            if ($this->db->insert('parciais_reservas', $data)) {
                return true;
            }
        }
    }
    ...
    public function update($data = null) {
        if ($data != null) {
            ...
            if ($this->db->update('parciais_reservas', $data)) {
                return true;
            }
        }
    }
    ...
    public function delete($pr_id) {
        if ($pr_id != null) {
            ...
            if ($this->db->delete("parciais_reservas")) {
                return true;
            }
        }
    }
    ...
    public function truncate() {
        if ($this->db->truncate("parciais_reservas")) {
            return true;
        }
    }
    ...
    public function listing() {
        ...
        return $this->db->get("parciais_reservas")->result();
    }
	
	public function search($pr_id) {
        $this->db->where("pr_id", $pr_id);
        return $this->db->get("parciais_reservas")->row_array();
    }
